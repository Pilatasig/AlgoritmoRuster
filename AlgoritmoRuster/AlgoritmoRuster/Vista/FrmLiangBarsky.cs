...
namespace AlgoritmoRuster.Vista
{
    public partial class FrmLiangBarsky : Form
    {
        ...
        private ControladorLiangBarsky controladorLiangBarsky;
        ...
        public FrmLiangBarsky()
        {
            ...
            controladorLiangBarsky = new ControladorLiangBarsky();
        ...
        private void panelDibujo_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (puntoFinal == null)
            {
                ...
                lineaAceptada = controladorLiangBarsky.RecortarLinea(ref p1CartClip, ref p2CartClip);
        ...
        private void dibujarVentanaCorte(Graphics g)
        {
            Point esq1 = dibujadorPlano.CartesianoAPantalla(
                new PointF(controladorLiangBarsky.XMin, controladorLiangBarsky.YMin),
                panelDibujo.Width, panelDibujo.Height);
            Point esq2 = dibujadorPlano.CartesianoAPantalla(
                new PointF(controladorLiangBarsky.XMax, controladorLiangBarsky.YMax),
                panelDibujo.Width, panelDibujo.Height);
