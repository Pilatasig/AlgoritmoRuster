...
namespace AlgoritmoRuster.Vista
{
    public partial class FrmLineaBresenham : Form
    {
        ...
        private void rellenarTabla()
        {
            ...
            int indice = 1;
            foreach (Point p in controladorBresenham.puntos)
            {
        ...
        private void panelDibujo_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (puntoFinal == null)
            {
                ...
                if (chkProgresivo.Checked)
                    controladorProgresivo.IniciarProgresivo(controladorBresenham.puntos);
                else
                {
                    controladorProgresivo.IniciarPasoAPaso(controladorBresenham.puntos);
