...
function filtrarTablaCargos() {
    ...
    cargosFiltrados.forEach(c => {
        ...
        const nomCargo = c.nombre ? c.nombre.trim() : ""; // Nemónico (GER)
        ...
        // SINCRO JSP: Imprimimos las 5 columnas estructurales
        cuerpoTabla.innerHTML += `
            <tr>
                ...
                <td class="text-center">
                    <button class="btn btn-sm btn-warning me-1 fw-semibold" 
                        onclick="abrirModalEditar('${codCargo}', '${nomCargo}', '${descCargo}', '${codigoDepar}')">
                        <i class="bi bi-pencil-fill"></i> Editar
                    </button>
                    <button class="btn btn-sm btn-danger fw-semibold" 
                        onclick="ejecutarEliminacion('${codCargo}')">
