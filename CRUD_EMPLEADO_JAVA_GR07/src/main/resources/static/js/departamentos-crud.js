...
async function cargarDepartamentos() {
    try {
        ...
        departamentos.forEach(d => {
            // ADAPTADO: Usamos las propiedades exactas que retorna la entidad Java (Jackson JSON)
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <button class="btn btn-sm btn-warning me-1 fw-semibold" 
                            onclick="abrirModalEditar('${codPK}', '${nemonico}', '${descripcion}')">
                            <i class="bi bi-pencil-fill"></i> Editar
                        </button>
                        <button class="btn btn-sm btn-danger fw-semibold" 
                            onclick="ejecutarEliminacion('${codPK}')">
