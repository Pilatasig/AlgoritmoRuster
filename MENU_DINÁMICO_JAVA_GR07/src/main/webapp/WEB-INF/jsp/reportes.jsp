...
<%
    ...
    boolean puedeReportCargos = permisos != null && (permisos.contains("P21") || permisos.contains("P22") || permisos.contains("P23") || permisos.contains("P24"));
    boolean puedeReportEmpleados = permisos != null && (permisos.contains("P31") || permisos.contains("P32") || permisos.contains("P33") || permisos.contains("P34"));
%>
<!DOCTYPE html>
<html lang="es">
<head>
