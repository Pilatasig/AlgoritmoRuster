...
function filtrarTabla() {
    ...
    const tieneP32 = typeof PERMISOS !== 'undefined' && PERMISOS.includes('P32');
    const tieneP34 = typeof PERMISOS !== 'undefined' && PERMISOS.includes('P34');
    ...
    filtrados.forEach(e => {
        ...
        if (tieneP32) acciones += `<button class="btn btn-sm btn-warning fw-semibold" onclick="abrirModalEditar('${cod}')"><i class="bi bi-pencil-fill"></i></button> `;
        if (tieneP34) acciones += `<button class="btn btn-sm btn-danger fw-semibold" onclick="ejecutarEliminacion('${cod}')"><i class="bi bi-trash-fill"></i></button>`;
        acciones += '</div>';
...
function renderizarTablaFamiliares() {
    ...
    const tieneP42 = typeof PERMISOS !== 'undefined' && PERMISOS.includes('P42');
    const tieneP44 = typeof PERMISOS !== 'undefined' && PERMISOS.includes('P44');
    ...
    cacheFamiliares.forEach(f => {
        ...
        let acciones = '<div class="d-flex justify-content-center gap-1">';
        if (tieneP42) acciones += `<button class="btn btn-sm btn-warning fw-semibold" onclick="abrirModalEditarFamiliar('${empCod}','${cod}')"><i class="bi bi-pencil-fill"></i></button> `;
        if (tieneP44) acciones += `<button class="btn btn-sm btn-danger fw-semibold" onclick="ejecutarEliminacionFamiliar('${empCod}','${cod}')"><i class="bi bi-trash-fill"></i></button>`;
        acciones += '</div>';
...
function renderizarEditTablaFamiliares() {
    ...
    cacheEditFamiliares.forEach(f => {
        ...
        const fec = f.fechaNacimiento ? f.fechaNacimiento : '';
        let acciones = '<div class="d-flex justify-content-center gap-1">';
        if (tieneP42) acciones += `<button class="btn btn-sm btn-warning fw-semibold" onclick="abrirModalEditarFamiliarEdit('${empCod}','${cod}')"><i class="bi bi-pencil-fill"></i></button> `;
        if (tieneP44) acciones += `<button class="btn btn-sm btn-danger fw-semibold" onclick="ejecutarEliminacionFamiliarEdit('${empCod}','${cod}')"><i class="bi bi-trash-fill"></i></button>`;
        acciones += '</div>';
